...
# TODO check for different potentials than point potential: is lattice numeration followed by impurity numeration? [suspected solution: define 1D like vector for impurity, than shape will follow sites numeration]
